      ...
      <div className="px-[18px] py-[100px] md:px-[40px] md:py-[160px]">
        ...
        <div className="mt-[60px] grid gap-[20px] md:mt-[100px] md:grid-cols-3 md:gap-[24px]">
          {tiers.map((t) => (
            <div
              key={t.name}
              className={`relative flex flex-col rounded-[2px] border p-[28px] md:p-[36px] ${
                t.featured
            ...
            >
              ...
              <div
                className={`mt-[12px] flex items-baseline gap-[12px] text-[12px] uppercase leading-none tracking-[0.16em] md:text-[13px] ${
                  t.featured ? "text-white/70" : "text-black/55"
                }`}
                style={{ fontFamily: "var(--font-geist-mono)" }}
              >
              ...
              <p
                className={`mt-[24px] text-[15px] leading-[1.5] md:text-[16px] ${
                  t.featured ? "text-white/85" : "text-black/75"
                }`}
              >
                {t.fit}
              </p>
              ...
              <ul
                className={`mt-[24px] space-y-[10px] text-[13px] leading-[1.45] md:text-[14px] ${
              ...
              >
                {t.includes.map((line) => (
                  <li key={line} className="flex items-start gap-[10px]">
                    <span
                      className={t.featured ? "text-white/40" : "text-black/35"}
                    >
                      —
                    </span>
                    <span>{line}</span>
